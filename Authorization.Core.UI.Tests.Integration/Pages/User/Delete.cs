...
namespace Authorization.Core.UI.Tests.Integration.Pages.User
{
    ...
    {
        internal const string Title = "Delete User";
        ...
        public static async Task<Delete> CreateAsync(HttpClient client, string userId, UIPageContext context = null)
        {
            var responseMessage = await client.GetAsync($"Admin/User/Delete?id={userId}");
